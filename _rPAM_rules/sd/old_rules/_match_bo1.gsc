/*	** rPAM SD RULESET (_match_BO1.gsc) **
...
//*================================== *** League Logo *** =======================================*//
	...
	game["leaguestring"] = &"^7CoDBASE ^3BO1 ^7Match Mode";
...
//*=============================== *** Match Setup Options *** ==================================*//
	...
	setcvar("scr_half_round", "13");		// Switch AFTER this round.
	setcvar("scr_half_score", "0");			// Switch AFTER this score.
	setcvar("scr_end_round", "26");			// End Map AFTER this round.
	setcvar("scr_end_score", "14");			// End Map AFTER this total score.
...
// S&D Settings
	setcvar("scr_sd_scorelimit", "3");		// Score limit per map
	setcvar("scr_sd_roundlimit", "6");		// Round limit per map
...
//	setcvar("sv_specblackout", "1");		// blackout for specs
