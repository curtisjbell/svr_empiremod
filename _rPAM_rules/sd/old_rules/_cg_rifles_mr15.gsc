/*	** rPAM SD RULESET (_cg_rifles_mr15.gsc) **
...
//*================================== *** League Logo *** =======================================*//
	...
	game["leaguestring"] = &"CyberGamer S&D Rifles MR15 Match Mode";
...
//*=============================== *** Match Setup Options *** ==================================*//
	...
	setcvar("scr_half_round", "15");		// Switch AFTER this round.
	setcvar("scr_half_score", "0");			// Switch AFTER this score.
	setcvar("scr_end_round", "30");			// End Map AFTER this round.
	setcvar("scr_end_score", "16");			// End Map AFTER this total score.
