/*	** rPAM SD RULESET (_public_boltrifles.gsc) **

	REISSUE Project Ares Mod version 1.11 by zyquist
	
	original script by by zyquist (aka reissue_)
...
//*================================== *** League Logo *** =======================================*//
	...
	game["leaguestring"] = &"Public S&D Bolt- Action Rifles Mode";
...
// Grace/Strat Period
	setcvar("scr_sd_graceperiod", "15");		// Grace Period
...
// Voting
	if (getcvar("scr_allow_vote") == "")
		setcvar("scr_allow_vote", "1");		// No Voting in a match
	if (getcvar("g_allowVote") == "")
		setcvar("g_allowVote", "1");		// No Voting in a match

// Timeouts
	setcvar("g_timeoutsAllowed", "0");		// number of timeouts per side	
//	setcvar("g_timeoutLength", "288000");		// length of timeouts
//	setcvar("g_timeoutRecovery", "10000");		// counter before match resumes
//	setcvar("g_timeoutBank", "576000");		// timeout counting per side
...
// Auto Screenshots / Console / Black Spec
	setcvar("g_autoscreenshot", "0");		// turns on autoscreenshot
