...
//*================================== *** League Logo *** =======================================*//
	...
	//setcvar("sv_mapRotationCurrent", "gametype sd map mp_railyard gametype sd map mp_rocket gametype ctf map mp_uo_carentan gametype sd map mp_stalingrad gametype sd map mp_brecourt gametype ctf map uo_neuville_ctf");
	//setcvar("sv_maprotation", "gametype dm map wawa_3daim_russian");
...
//*=============================== *** Match Setup Options *** ==================================*//
	...
	setcvar("scr_end_score", "11");			// End Map AFTER this total score.
...
{
	setcvar("scr_half_round" , "0");		// Switch AFTER this round.
	setcvar("scr_end_round" , "1");			// End Map AFTER this round.
	setcvar("scr_end_score" , "1");			// End Map AFTER this total score.
}
...
// Grace/Strat Period
	setcvar("scr_sd_graceperiod", "0");		// Grace Period
...
// rPAM HUD Items
	...
	setcvar("rpam_branding", "1");			//rPAM Branding on/off
...
// ** NOT Likely to ever change **
	...
	setCvar("scr_teambalance", "1");		// Team Balance OFF
